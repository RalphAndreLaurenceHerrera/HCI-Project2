...
CREATE DATABASE IF NOT EXISTS JBoyDB DEFAULT CHARACTER SET utf8mb4 DEFAULT COLLATE utf8mb4_unicode_ci;
USE JBoyDB;
...
CREATE TABLE IF NOT EXISTS SubCategory(
 ...
 -- Create a table Category with columns: categoryID (PK), categoryName, categoryDesc.
CREATE TABLE IF NOT EXISTS Category(
 ...
 -- Create a table Items with columns: itemID (PK), subcategoryID (FK), itemName (UNIQUE), itemPrice, itemDesc, itemAvail, itemImageLocation.
CREATE TABLE IF NOT EXISTS Items(
 ...
 -- Create a junction table ItemCategory.
...
CREATE TABLE IF NOT EXISTS Notices (
    ...
    noticeUpdated TIMESTAMP NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
...
CREATE INDEX idx_items_subcategory ON Items(subCategoryID);
CREATE INDEX idx_orders_user ON Orders(userID);
CREATE INDEX idx_orderitem_order ON OrderItem(orderID);

 -- For Searching
CREATE FULLTEXT INDEX idx_notices_body ON Notices(noticeBody);
...
INSERT INTO Items(itemID, subCategoryID, itemName, itemPrice, itemDesc, itemAvail, itemImageLocation) VALUES
    ...
    ('I00017', 'SUB00003', '12 pcs Harumaki Salad',                     130,    '12 pieces of Harumaki salad wrapped in rice paper.',                                                                                                                   1,  '/jboymakiandbento/assets/images/item-images/Salad/12pcs-HarumakiSalad.jpg'),
    ('I00018', 'SUB00005', '18 pcs Harumaki Salad',                     220,    '18 pieces of Harumaki salad wrapped in rice paper.',                                                                                                                   1,  '/jboymakiandbento/assets/images/item-images/Salad/18pcs-HarumakiSalad.jpg'),
    ('I00019', 'SUB00007', '30 pcs Harumaki Salad',                     400,    '30 pieces of Harumaki salad wrapped in rice paper.',                                                                                                                   1,  '/jboymakiandbento/assets/images/item-images/Salad/30pcs-HarumakiSalad.jpg'),
